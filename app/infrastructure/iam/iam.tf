...
resource "aws_iam_policy" "external_dns" {
  name = "external-dns"
  path = "/"
  description = "Permissions for External-DNS service account to manage Route53 resources"
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
      {
...
resource "aws_iam_policy" "cert-manager" {
  ...
  path = "/"
  description = "Permissions for Certificate Manager to issue letsencrypt certs and use DNS01 challenges against Route53"
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
      {
...
resource "aws_iam_user_policy_attachment" "letsencrypt" {
